...
public class FileIO {
	...
	public void getFile(ArrayList<Eatery> eat, ReservedEatery re) {
		Path text = Paths.get("C:\\Users\\KMW\\Desktop\\test(write).txt");
		try {
			//BufferedReader reader = Files.newBufferedReader(text, Charset.forName("euc-kr"));
			BufferedReader reader = Files.newBufferedReader(text, Charset.forName("UTF-8"));
			int i = 0;
		...
		Path text2 = Paths.get("C:\\Users\\KMW\\Desktop\\reservate_test(write).txt");	//예약 정보 불러오기
		
		try {
			BufferedReader reader = Files.newBufferedReader(text2, Charset.forName("UTF-8"));
			String temp;
	...
	public void setFile(ArrayList<Eatery> eat, ReservedEatery re) {
		File file = new File("C:\\Users\\KMW\\Desktop\\test(write).txt");
		String temp = null;
		...
		File file2 = new File("C:\\Users\\KMW\\Desktop\\reservate_test(write).txt");	//예약 정보 저장
